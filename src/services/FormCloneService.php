...
class FormCloneService extends Component
{
    ...
    public function duplicate(Form $source, array $overrides = []): Form
    {
        ...
        // The copy is a brand-new form, so the edition gate sees every Standard
        ...
        // this, duplication would mint unlimited Standard forms on Solo.
    ...
    public function createFromStencil(Stencil $stencil): Form
    {
        ...
        // new-form source so a Standard-featured stencil can't escalate Solo (#282).
    ...
    /**
     * Reject cloning a form (or stencil) that would introduce Standard field types
     * or Standard form-capabilities onto Solo. The clone is always a brand-new form,
     * so there is no "existing" usage to grandfather — every Standard feature in the
    ...
    private function assertEditionAllows(iterable $items, bool $saveResume, ?string $edition = null): void
    {
        ...
        $blocked = array_merge(
            Editions::blockedNewStandardFields($types, [], $edition),
