...
class PdfService extends Component
{
    ...
    {
        // PDF generation is Standard; gating the single availability check keeps every
     ...
     * present but the edition gates it" (upgrade to Standard).
     */
    ...
    {
        // Gate the generation path on the same isAvailable() the CP uses (Standard +
