...
class FormFieldType extends SimpleFormObjectType
{
    ...
    protected static function getDescription(): string
    {
        return 'A single field in a Simple Form schema. All field variants share '
            ...
            . '`select`, `checkbox`, `radio`, `date`, `number`, `file`, `payment`, '
            . 'and the element-relation types `entry`, `category`, `tag`, `user`, '
            . '`asset`) tells a client how to render it, and '
            . '`options`/`validation`/`relation` carry the variant-specific detail.';
    }
