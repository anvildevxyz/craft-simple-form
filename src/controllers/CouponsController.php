...
class CouponsController extends Controller
{
    ...
    public function actionSave(): Response
    {
        ...
        // Standard feature. A downgraded site keeps its existing coupons — they stay
        ...
        if ($coupon->id === null && !Editions::isStandard()) {
            Craft::$app->getSession()->setError(Craft::t(
                'simple-form',
                'Creating coupons requires the Standard edition.',
            ));
