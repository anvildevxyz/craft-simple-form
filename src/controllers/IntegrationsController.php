...
class IntegrationsController extends Controller
{
     ...
     * the always-available handles; Standard gets everything.
     *
    ...
    {
        return Craft::t('simple-form', 'The {type} integration requires the Standard edition.', [
    ...
    public function actionEdit(?int $integrationId = null): Response
    {
        ...
        // existing Standard integration on a downgraded Solo install is still allowed
    ...
    public function actionSave(): Response
    {
        ...
        // by the edition gate below to tell "keep an existing Standard integration" from
        // "introduce a Standard type".
        ...
        // Edition gate (authoritative): Solo may not introduce a Standard integration
        // type — whether by creating one or by editing an existing Solo-allowed
        // integration and swapping its type. Keeping an integration on the Standard type
