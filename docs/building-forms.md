...
> **Standard edition.** Multi-page forms require [Standard](editions.md). See [Editions](editions.md).
...
> **Standard edition.** Conversational mode requires [Standard](editions.md). See [Editions](editions.md).
...
> **Standard edition.** Save & continue later requires [Standard](editions.md). See [Editions](editions.md).
...
> **Standard edition.** Partial capture requires [Standard](editions.md). See [Editions](editions.md).
