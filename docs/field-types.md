...
Eleven of them are **Standard** — Signature, Payment, Rating, Opinion Scale,
...
> **Standard edition.** This field type requires [Standard](editions.md).
...
> **Standard edition.** All five relation types (`entry`, `category`, `tag`, `user`,
> `asset`) require [Standard](editions.md).
