 ...
 * importing: the copy is a brand-new form, so every Standard feature it carries is
...
class CloneEditionGateTest extends TestCase
{
    ...
    public function testSoloBlocksCloningStandardFieldTypes(): void
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageMatches('/Standard edition/');
