...
/**
 * Notification PDF attachments + submission detail downloads. CP UI + Mailpit.
 *
...
class NotificationAttachmentsCest
{
    ...
    public function testNotificationEditShowsAttachmentToggles(SmokeTester $I): void
    {
        $I->markTestSkipped(self::SKIP_REASON);
    }

    public function testSubmissionEmailCarriesPdfAttachment(SmokeTester $I): void
    {
        $I->markTestSkipped(self::SKIP_REASON);
    }

    public function testSubmissionDetailDownloadsPdf(SmokeTester $I): void
    {
        $I->markTestSkipped(self::SKIP_REASON);
    }
}
