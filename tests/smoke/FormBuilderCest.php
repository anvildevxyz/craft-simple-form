...
/**
 * Form builder: create a form and add fields. CP form-builder UI.
 *
...
class FormBuilderCest
{
    ...
    public function testCreateFormInCP(SmokeTester $I): void
    {
        $I->markTestSkipped(self::SKIP_REASON);
    }

    public function testAddFieldsToForm(SmokeTester $I): void
    {
        $I->markTestSkipped(self::SKIP_REASON);
    }

    public function testFormAppearsInCP(SmokeTester $I): void
    {
        $I->markTestSkipped(self::SKIP_REASON);
    }
}
