...
class EditionMatrixCest extends BaseSmokeCest
{
    ...
    public function soloGatesTheProSurface(SmokeTester $I): void
    {
        ...
        // Authoring gates.
        $I->assertNotEmpty(Editions::blockedNewStandardFields(['rating', 'payment'], []), 'Solo blocks Pro fields');
    ...
    public function proUnlocksTheFullSurface(SmokeTester $I): void
    {
        ...
        $I->assertSame([], Editions::blockedNewStandardFields(['rating', 'payment', 'repeater', 'signature'], []));
    ...
    /**
     * No-new-escalation: a Solo form that already uses these Standard features keeps
    ...
    public function soloAllowsJumpsAndWorkflow(SmokeTester $I): void
    {
        ...
        $I->assertFalse(
            Editions::blocksStandardSettingChange('enableWorkflow', false, true),
