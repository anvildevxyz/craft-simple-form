...
$checks = [
    ...
    'Migration' => file_exists('src/migrations/Install.php'),
    'TwigExtension' => file_exists('src/TwigExtension.php'),
    'Form templates' => file_exists('src/templates/forms/index.twig') && file_exists('src/templates/forms/edit.twig'),
    'Submission templates' => file_exists('src/templates/submissions/index.twig') && file_exists('src/templates/submissions/view.twig'),
