...
by default** — run the Standard edition to unlock the full feature set.
...
built on Standard keeps rendering and accepting submissions after a downgrade to
Solo — you just can't add more Standard features. Spam protection, denylists, and
retention keep running so data hygiene never regresses; the Standard-only back-office
...
PDF, no audit rows are written — and resume on returning to Standard.
...
**Solo is free.** Install it and use it in as many projects as you like, at no
cost.

**Standard is $39**, a one-off per-project license, plus $19/year after the first
year if you want continued updates and support. Renewing is optional — an
expired license keeps working, it just stops receiving updates.

Licensing and updates are handled through the Craft Plugin Store. See
[LICENSE.md](LICENSE.md) for the full terms and [Editions](docs/editions.md)
